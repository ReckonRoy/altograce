...
customElements.define("admin-header", class extends HTMLElement {
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div id="side-nav">
        ...
        <ul>
          ...
          <li id="hr-link">HR</li>
          <li id="product-pkg-link">Product Management</li>
        </ul>
      </div>
    `;
    ...
    let headerRoutes = () => {
      ...
      this.shadowRoot.getElementById("hr-link").addEventListener("click", () => {
        location.href = "/admin/hr";
      });
      this.shadowRoot.getElementById("product-pkg-link").addEventListener("click", () => {
        location.href = "/package/management";
      });
    };
